# Quatrième réponse et modification effectuée
	...
	<main class="container">
		...
		<section id="a-propos" class="section">
			...
			<div class="card reveal">
				<p>
					Je m’appelle Maxime. Ce site est en HTML, CSS et JS “vanilla” pour maîtriser les bases.
				</p>
				<p>
					Je suis professionnel, polyvalent, sérieux et motivé, je possède une forte capacité d’adaptation et un sens aigu du travail bien fait.
					Habitué à travailler en équipe comme en autonomie, je suis prêt à m’investir pleinement dans les missions qui me seront confiées
					et à développer mes compétences au sein de votre organisation.
				</p>
				<p class="help">Astuce: lis le code pour comprendre le carrousel, le filtrage par statut, le mode sombre, et la validation.</p>
			</div>
		</section>
			...
			<div class="card reveal">
				...
				<div class="carousel" aria-roledescription="carrousel" aria-label="Projets en vedette">
					<div class="carousel-track" id="carouselTrack">
						<article class="slide" data-status="fini">
							<div class="thumb" aria-hidden="true"></div>
							<div>
								<h3>Projet Red (Golang)</h3>
								<p class="meta">Statut: Fini</p>
						...
						<article class="slide" data-status="en-cours">
							<div class="thumb" aria-hidden="true"></div>
							<div>
								<h3>Golem — Projet YDays</h3>
								<p class="meta">Statut: En cours</p>
				...
				<!-- Grille filtrable par statut -->
				<div class="projects-grid" id="projectsGrid" style="margin-top: 12px;">
					<article class="project" data-status="fini">
						<div class="cover" aria-hidden="true"></div>
						<div class="content">
							<h4>Projet Red</h4>
							<p class="meta">Golang · Statut: Fini</p>
						</div>
					</article>
					...
					<article class="project" data-status="fini">
						...
						<div class="content">
							<h4>Power 4</h4>
							<p class="meta">Go · Statut: Fini</p>
						</div>
					</article>

					<article class="project" data-status="en-cours">
						<div class="cover"></div>
						<div class="content">
							<h4>Golem (YDays)</h4>
							<p class="meta">Collab · Statut: En cours</p>
						</div>
					</article>

					<!-- Hypothèses par défaut ci-dessous (modifiable) -->
					<article class="project" data-status="en-cours">
						<div class="cover"></div>
						<div class="content">
							<h4>Portfolio en Prompt Engineering</h4>
							<p class="meta">IA/Prompt · Statut: En cours</p>
						</div>
					</article>
					...
					<article class="project" data-status="fini">
						...
						<div class="content">
							...
							<p class="meta">Réseau/Go · Statut: Fini</p>
						</div>
					</article>
				</div>
			</div>
...
// 5) Filtrage des projets par statut (data-status: "fini" | "en-cours")
(function filtering() {
	...
	function apply(filter) {
		cards.forEach(card => {
			const ok = filter === 'all' || card.dataset.status === filter;
