...
<head>
	...
	<style>
		...
		* { box-sizing: border-box; }
		...
		.project .cover {
			height: 140px;
			background: linear-gradient(135deg, color-mix(in oklab, var(--primary) 35%, transparent), color-mix(in oklab, var(--bg) 85%, var(--bg-soft)));
		}
...
<body>
	...
	<main class="container">
		<section class="hero">
			<div class="hero-card reveal">
				...
				<p class="lead">
					Je construis des interfaces propres, accessibles et rapides. Ce portfolio présente mes compétences,
					quelques projets, et un moyen simple de me contacter.
				</p>
				<div class="hero-cta">
			...
			<div class="hero-card reveal delay-1" aria-hidden="true">
				<!-- Espace visuel décoratif -->
				<div style="aspect-ratio: 1/1; border-radius: 16px; border: 1px solid var(--border); background:
		...
		<section id="a-propos" class="section">
			...
			<div class="card reveal">
				<p>
					Je m’appelle Maxime. J’aime apprendre vite et transformer des idées en expériences simples.
					Ce site est construit en HTML, CSS et JavaScript vanilla, sans framework, pour bien maîtriser les bases.
				</p>
				<p class="help">Astuce: lis le code source pour voir comment le carrousel, le filtrage et le mode sombre fonctionnent.</p>
			</div>
		</section>
			...
			<div class="card reveal">
					...
					<div class="carousel-track" id="carouselTrack">
						<article class="slide" data-category="web">
							...
							<div>
								...
								<p>Un site vitrine responsive avec thème clair/sombre et bonnes pratiques d’accessibilité.</p>
							</div>
						</article>
						<article class="slide" data-category="design">
							...
							<div>
								...
								<p>Bibliothèque de boutons, cartes et badges avec variables CSS et ombres douces.</p>
							</div>
						</article>
						<article class="slide" data-category="autres">
							...
							<div>
								...
								<p>Petite app vanilla JS avec persistence localStorage et validations.</p>
							</div>
						</article>
					</div>
				...
				<div class="projects-grid" id="projectsGrid" style="margin-top: 12px;">
					<article class="project" data-category="web">
						...
						<div class="content">
							<h4>Portfolio perso</h4>
							<p class="meta">Web · HTML/CSS/JS</p>
						</div>
					</article>
					<article class="project" data-category="web">
						<div class="cover"></div>
					...
					<article class="project" data-category="design">
						...
						<div class="content">
							<h4>Styleguide</h4>
							<p class="meta">Design · Système de styles</p>
						</div>
					</article>
					...
					<article class="project" data-category="design">
						...
						<div class="content">
							<h4>Wireframes</h4>
							<p class="meta">Design · Prototype</p>
						</div>
					</article>
					<article class="project" data-category="web">
						<div class="cover"></div>
	...
	<script>
		// Utilitaire: en douceur, clair/pédago
		// 1) Thème sombre/clair avec persistance
		(function theme() {
		...
		// 2) Compteur de visites basé sur localStorage
		(function visits() {
		...
		// 3) Animations d’entrée lorsque l’élément entre dans la vue
		...
		// 5) Filtrage des projets par catégorie (boutons + effet)
		(function filtering() {
		...
		// 6) Validation en temps réel du formulaire (HTML5 + JS)
		(function formValidation() {
			...
			function validateOne(f) {
				...
				let valid = true;
				if (f.type === 'text' && f.min) valid = v.length >= f.min;
				if (f.type === 'email') valid = isValidEmail(v);
				f.container.classList.toggle('invalid', !valid);
				f.container.classList.toggle('valid', valid);
				return valid;
			}

			fields.forEach(f => {
				['input', 'blur'].forEach(ev => f.el.addEventListener(ev, () => validateOne(f)));
			});
			...
			form.addEventListener('submit', (e) => {
				...
				// Démo: on ne soumet pas vraiment.
